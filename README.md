...
<br>
To be really plain, you could just download (and unzip) the json file uploaded here if all you need is frame data. It's a 3D array of dimensions 6572x48x36, so:
...
You could also take BAframesAsTest.txt and use the fact that each frame is represented by 36 characters across 48 rows.
